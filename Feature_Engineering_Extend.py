...
class Feature_Engineering_Extend:
    ...
    def __init__(self, training_normal_data_dict, training_attack_data_dict, testing_normal_data_dict,
        ...
        self.__testing_normal_data = testing_normal_data_dict
        self.__testing_normal_data = testing_attack_data_dict
